...
- We have static wireframes, but what do we know about the actual look and feel of the application? How are we planning on transitioning from these static views with good user look and feel?
...
Typically these are the questions I would want answers to from the relevant stakeholders during a projects planning phase. That may mean time for Product managers, Designers, and Devs to go collect these answers so we can better estimate the effort involved in a project.
...
- I would make the issue card's titles clickable, and link to the actual github issue.
